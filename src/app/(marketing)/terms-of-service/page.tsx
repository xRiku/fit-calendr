			...
			<div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
				...
				<div className="space-y-10 text-neutral-300 leading-relaxed">
					<section>
						...
						<p>
							By using FitCalendr, you agree to these Terms of Service. If you
					...
					<section>
						...
						<p>
							FitCalendr is a personal fitness tracking tool. You agree to use
							it only for lawful purposes and not to misuse or attempt to
							disrupt the service.
						</p>
					</section>
					...
					<section>
						...
						<p>
							You own all data you enter into FitCalendr. We do not claim any
							ownership over your fitness or meal logs.
						</p>
					</section>
					...
					<section>
						...
						<p>
							FitCalendr is provided free of charge. We reserve the right to
					...
					<section>
						...
						<p>
							FitCalendr is provided "as is" without warranties of any kind. We
